...
<div class="app">
  ...
  <div class="hero">
    ...
    <p>The gold standard educational game engine — 6 games teaching kids, developers, AI practitioners, and language learners across 89 chapters.</p>
  </div>
  ...
  <div class="sec">
    ...
    <div class="games">
      ...
      <div class="gc"><div class="gc-name">🌊 Learn Japanese</div><div class="gc-stats">8 chapters · 304 challenges · Japanese from English</div><div class="gc-url">learn-japanese-rose-two.vercel.app</div><div class="gc-bar"><div class="gc-fill" style="width:100%"></div></div></div>
    </div>
  </div>
  ...
  <div class="sec">
    ...
    <div class="items">
      <div class="item"><div class="item-icon">🔊</div><div class="item-title">Google TTS Voices</div><div class="item-desc">Studio-quality character voices — Puck, CIPHER, ARIA, 龙龙, Sofia, Sensei. Listen button on questions, lessons, intros.</div></div>
      <div class="item"><div class="item-icon">🖼️</div><div class="item-title">Rich Media</div><div class="item-desc">Unsplash images on zone intros, code blocks, markdown rendering, video/iframe support in lessons.</div></div>
      <div class="item"><div class="item-icon">🗄️</div><div class="item-title">Postgres + Auth</div><div class="item-desc">Neon database, bcrypt auth, session cookies, per-user progress across devices. Admin analytics dashboard.</div></div>
      ...
      <div class="item"><div class="item-icon">📱</div><div class="item-title">PWA + Sounds</div><div class="item-desc">Installable on mobile, offline caching, synthesized audio feedback for correct/wrong/level-up.</div></div>
      <div class="item"><div class="item-icon">🏆</div><div class="item-title">Engagement</div><div class="item-desc">Daily challenges (2x XP), streaks + combos, leaderboards, achievements, adaptive difficulty.</div></div>
      <div class="item"><div class="item-icon">📊</div><div class="item-title">Analytics</div><div class="item-desc">Admin dashboard, signup notifications, per-challenge pass rates, user activity tracking.</div></div>
      <div class="item"><div class="item-icon">✨</div><div class="item-title">Premium UX</div><div class="item-desc">Page transitions, glassmorphism, confetti celebrations, SVG progress rings, micro-interactions.</div></div>
      <div class="item"><div class="item-icon">🧪</div><div class="item-title">65 Tests + CI</div><div class="item-desc">Automated tests on Python 3.10/3.11/3.12 via GitHub Actions. All green.</div></div>
    </div>
  </div>
  ...
  <div class="sec">
    ...
    <div class="items">
      <div class="item item-b"><div class="item-icon">🎙️</div><div class="item-title">Voice Quality</div><div class="item-desc">Exploring ElevenLabs and Play.ht for more natural, emotional character voices.</div></div>
      <div class="item item-b"><div class="item-icon">📚</div><div class="item-title">More Content</div><div class="item-desc">Always expanding — new chapters across all 6 games every week.</div></div>
      <div class="item item-b"><div class="item-icon">📣</div><div class="item-title">Social Automation</div><div class="item-desc">MoneyPrinterV2-style automated posting to Twitter/X and YouTube (needs API keys).</div></div>
    </div>
  </div>
  ...
  <div class="sec">
    ...
    <div class="items">
      <div class="item item-p"><div class="item-icon">🤖</div><div class="item-title">AI Tutor</div><div class="item-desc">Claude explains wrong answers in real-time, generates personalized learning paths.</div></div>
      ...
      <div class="item item-p"><div class="item-icon">🔄</div><div class="item-title">Spaced Repetition</div><div class="item-desc">Anki-style smart review scheduling built into the game engine.</div></div>
      ...
      <div class="item item-p"><div class="item-icon">✏️</div><div class="item-title">Challenge Editor</div><div class="item-desc">Web-based UI for creating challenges without writing code.</div></div>
      <div class="item item-p"><div class="item-icon">🎮</div><div class="item-title">2D Game World</div><div class="item-desc">Premium browser game engine (Phaser 4 or custom) for immersive RPG experience.</div></div>
  ...
  <div class="footer">
    ...
    Built by <a href="https://github.com/thorski1">thorski1</a>
  </div>
