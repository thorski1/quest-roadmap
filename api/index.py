...
<meta name="description" content="The gold standard educational game engine. 6 games, 118 chapters, 5,451 challenges.">
<meta property="og:title" content="Quest Engine Roadmap">
<meta property="og:description" content="6 games, 118 chapters, 5,451 challenges across education, DevOps, AI, and 3 languages.">
...
<div class="app">
  ...
  <div class="hero">
    ...
    <p>The gold standard educational game engine — 6 games teaching kids, developers, AI practitioners, and language learners across 118 chapters.</p>
  </div>

  <div class="stats">
    <div class="stat"><div class="sv" style="color:var(--p)">6</div><div class="sl">Games</div></div>
    <div class="stat"><div class="sv" style="color:var(--sec)">118</div><div class="sl">Chapters</div></div>
    <div class="stat"><div class="sv" style="color:var(--w)">5,451</div><div class="sl">Challenges</div></div>
  ...
  <div class="sec">
    ...
    <div class="games">
      <div class="gc"><div class="gc-name">🌸 The Primer</div><div class="gc-stats">40 chapters · 1,864 challenges · Ages 5-12</div><div class="gc-url">primer-ecru.vercel.app</div><div class="gc-bar"><div class="gc-fill" style="width:100%"></div></div></div>
      <div class="gc"><div class="gc-name">⚡ NEXUS Quest</div><div class="gc-stats">37 chapters · 1,962 challenges · For developers</div><div class="gc-url">nexus-quest-eta.vercel.app</div><div class="gc-bar"><div class="gc-fill" style="width:100%"></div></div></div>
